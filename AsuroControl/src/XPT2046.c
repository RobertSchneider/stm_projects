...
/* Private variables ---------------------------------------------------------*/
Coordinate    display;
Matrix matrix = {691080.000000, -11960.000000, -168905200.000000, -40260.000000, 491370.000000, -2396100.000000, 7904300.000000};
...
void TouchPanel_Calibrate(void)
{
  ...
  printf("%f %f %f %f %f %f %f\n", matrix.An,matrix.Bn,matrix.Cn,matrix.Dn,matrix.En,matrix.Fn,matrix.Divider);
  SSD1289_Clear(Black);
} 
