...
void Set_Power()
{
    ...
    GPIO_InitStructure.GPIO_Pin = SSD1289_POWER_PIN;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
    GPIO_Init(SSD1289_CTRL_PORT, &GPIO_InitStructure);
    GPIO_SetBits(SSD1289_CTRL_PORT, SSD1289_POWER_PIN);
}
void Clr_Power()
{
    GPIO_InitTypeDef GPIO_InitStructure;
    ...
    GPIO_Init(SSD1289_CTRL_PORT, &GPIO_InitStructure);
    GPIO_ResetBits(SSD1289_CTRL_PORT, SSD1289_POWER_PIN);
}
...
static void SSD1289_Configuration(void)
{
	...
	/* Enable clocks */
	RCC_AHB1PeriphClockCmd( RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOE | RCC_AHB1Periph_GPIOC, ENABLE);  
    ...
    GPIO_InitStructure.GPIO_Pin = SSD1289_RESET_PIN | SSD1289_nWR_PIN | SSD1289_nRD_PIN | SSD1289_CS_PIN | SSD1289_RS_PIN | SSD1289_POWER_PIN;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
    GPIO_Init(SSD1289_CTRL_PORT, &GPIO_InitStructure);
	
    /* configure BACKLIGHT pin */
	GPIO_InitStructure.GPIO_Pin = SSD1289_BACKLIGHT_PIN | GPIO_Pin_1;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
...
void pulse_low(GPIO_TypeDef *bus, int p)
{
    setBit(bus, p, 0);
    setBit(bus, p, 1);
}
